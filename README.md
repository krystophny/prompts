...
* Follow BACKLOG.md and get it done. No cheating, no shortcuts, no simplifications. Write tests (RED phase), implement full functionality, run tests (GREEN phase), update BACKLOG.md, commit, push. Go on to next task and repeat until all sprints are done.
