...
* Follow BACKLOG.md and get it done. No cheating, no shortcuts, no simplifications. Write tests that initially fail (RED phase), implement full functionality to make them pass (GREEN phase), clean up implementation (REFACTOR phase), 
